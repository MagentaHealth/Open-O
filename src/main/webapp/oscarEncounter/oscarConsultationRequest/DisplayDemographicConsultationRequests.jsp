		...
		<table class="table">
			<tr>
				<td style="white-space:nowrap; padding-left: 0">
					<a href="javascript:popupOscarRx(700,960,'${pageContext.request.contextPath}/oscarEncounter/oscarConsultationRequest/ConsultationFormRequest.jsp?de=<%= Encode.forUriComponent(demo) %>&teamVar=<%= Encode.forUriComponent(team) %>')">
						<bean:message
