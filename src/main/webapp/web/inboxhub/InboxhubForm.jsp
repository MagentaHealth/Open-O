        ...
        <div class="d-grid">
            ...
            <div class="btn-group" role="group">
                ...
                <input type="radio" class="btn-check" name="abnormal" id="Abnormal" value="Abnormal"
                       ...
                       checked <% } %>>
                <label class="btn btn-outline-primary" for="Abnormal">Abnormal (<%=categoryData.getAbnormalCount()%>
                    )</label>
                <input type="radio" class="btn-check" name="abnormal" id="Normal" value="Normal"
                       ...
                       checked <% } %>>
                <label class="btn btn-outline-primary" for="Normal">Normal (<%=categoryData.getNormalCount()%>)</label>
            </div>
            <br>
            <label class="fw-bold text-uppercase mb-2">
                Report Status
            ...
            <div class="btn-group" role="group">
                ...
                <input type="radio" class="btn-check" name="status" id="statusFiled" value="F"
                       ...
                       checked <% } %>>
                <label class="btn btn-outline-primary" for="statusFiled">Filed</label>
                <br>
            </div>
            <br>
            ...
            <div class="btn-group" role="group">
                <input type="radio" class="btn-check" name="searchAll" id="physicianAll" value="true"
                       ...
                       checked <% } %>>
                <label class="btn btn-outline-primary" for="physicianAll">All Physicians</label>
                <input type="radio" class="btn-check" name="searchAll" id="physicianUnclaimed" value="false"
                       ...
                       checked <% } %>>
                <label class="btn btn-outline-primary" for="physicianUnclaimed">Unclaimed Physicians</label>
