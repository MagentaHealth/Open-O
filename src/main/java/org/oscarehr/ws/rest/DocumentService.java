...
public class DocumentService extends AbstractServiceImpl{
    ...
    public Response uploadPendingDocuments(DocumentTo1 documentTo1, @Context HttpServletRequest request) {
        ...
        documentManager.addDocumentToQueue(loggedInInfo, document.getDocumentNo(), documentTo1.getQueue());

        return Response.ok(createResponseMap(documentTo1.getFileName(), "Success", "Document uploaded successfully.")).build();
    }
